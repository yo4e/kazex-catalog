...
実際の申請画面へ転記する際は `templates/priority-pitch.md` を複製して使用する。
...
2026-08-18の実申請画面スクリーンショットで、申請フローが以下の7ステップ順であることを再確認した。
...
同画面では、選択した代表曲が申請冒頭に表示され、Step 1のリリース概要はRequired・500文字上限として表示される。

2026-08-12のブラウザ実画面確認では、以下も確認済み。
